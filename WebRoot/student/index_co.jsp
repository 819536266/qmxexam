    <%@ page language="java" contentType="text/html; charset=UTF-8"
        ...
        <style type="text/css">
        #div_but{
        	width:320px; height:120px;border:1px solid #F00;float:right
        }
     ...
     <%--   <font size="4" face="楷体">判断题</font>--%>
        ...
        <div align="center" >
        <a href="<%=path %>/getRandomSubject.action" ><button style="background-color: rgba(144, 238, 144,0.9); height:
        45px;width: 20%">重做</button></a>

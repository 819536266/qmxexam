                    ...
                    <tr>
                        <td colspan="6" align="center">
                            ...
                            <s:if test="#request.page.hasPrePage">
                                ...
                                <a href="studentAssessQuery.action?currentPage=1&term=${term}&sclass=${stusclass}&name=${name}&type=${type}">首页</a> |
                                <a href="studentAssessQuery.action?currentPage=${page.currentPage - 1}&term=${term}&sclass=${stusclass}&name=${name}&type=${type}">上一页</a> |
                            </s:if>
                            <s:else>
                                首页 | 上一页 |
                            </s:else>
                            <s:if test="#request.page.hasNextPage==true">
                                <a href="studentAssessQuery.action?currentPage=${page.currentPage + 1}&term=${term}&sclass=${stusclass}&name=${name}&type=${type}">下一页</a> |
                                <a href="studentAssessQuery.action?currentPage=${page.totalPage}&term=${term}&sclass=${stusclass}&name=${name}&type=${type}">尾页</a>
                            </s:if>
                            <s:else>
                                下一页 | 尾页
                            </s:else>

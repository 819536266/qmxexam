...
<div class="loginpanel">
    <div class="loginpanelinner">
        ...
        <s:form action="regStudentAction.action" method="post">
        ...
        <!--表单开始-->
        <!--<form id="form-reg" action="regAction" >
            --><!--用户名-->
        <div class="inputwrapper animate2 bounceIn">
            <label>名字：</label>
            <div>
                <input type="text" name="studentName" placeholder="请输入用户名">
    ...
    <div class="inputwrapper animate2 bounceIn">
        <label> ID：</label>
        <div>
            <input type="text" name="studentID" placeholder="请输学号">
        </div>
    </div>
    <!--员工部门-->
    <div class="inputwrapper animate2 bounceIn">
    ...
    <div class="inputwrapper animate5 bounceIn">
        <input type="submit" value="员工注册" style="width: 100%"/>
    </div>

    </s:form>
    <div class="inputwrapper animate5 bounceIn">
        <%--<button style="background-color: #e6e6e6;"><a href="reg.jsp">员工注册</a></button>
        --%>

        <a href="<%=path %>/regTeacher.jsp">
            <button style="background-color: #e6e6e6;">老师注册</button>
        </a>
    </div>
    <div class="inputwrapper animate5 bounceIn">
